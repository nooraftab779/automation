...
class myUnet(object):
    ...
    def train(self):
        file = f'{project_name}{os.path.sep}current training{os.path.sep}UNET.txt'
        print("Creating File")
        print(file)
        open(file, 'a').close()
        print("loading data")
        ...
        print('Fitting model...')
        model.fit(imgs_train, imgs_mask_train, batch_size=1, epochs=1, verbose=1,
